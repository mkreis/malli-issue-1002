...
The `home-routes` handler in the `malli-issue-1002.routes.home` namespace
...
The `home-page` function will in turn call the `malli-issue-1002.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `malli-issue-1002.handler` namespace:
...
Request middleware functions are located under the `malli-issue-1002.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `malli-issue-1002.dev-middleware` namespace found in
